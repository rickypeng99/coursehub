...
CREATE TABLE `Users_Comments` (
  ...
  CONSTRAINT `users_comments_ibfk_1` FOREIGN KEY (`net_id`) REFERENCES `Users` (`net_id`),
  CONSTRAINT `users_comments_ibfk_2` FOREIGN KEY (`comment_id`) REFERENCES `Comments` (`comment_id`)
...
-- Dump completed on 2019-07-09 15:29:18
